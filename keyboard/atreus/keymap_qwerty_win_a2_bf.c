...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
         ...
         KC_ESC, SHIFT(KC_3), KC_LGUI, KC_LSFT, KC_BSPC, KC_LALT, KC_FN4, \
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), KC_UP, KC_HOME, KC_END, \
         ...
         KC_ESC, SHIFT(KC_INS), KC_LGUI, KC_LSFT, KC_BSPC, KC_LALT,     \
         KC_FN4, KC_SPC, KC_FN0, KC_DOT, KC_0, KC_EQUAL),
  ...
  KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP,              \
         ...
         KC__VOLDOWN, KC_NO, KC_LGUI, KC_LSFT, KC_BSPC, KC_LALT,        \
         KC_FN4, KC_FN1, KC_FN0, KC_PSCREEN, KC_SLCK, KC_PAUSE)
};
