 ...
 *  [    ]      (     )    &        ||       `     1     2     3    \
 * L2  insert alt shift bksp ctrl || super space   fn    .     0    =
 */
#define FN_ARROW_LAYER   KEYMAP(SHIFT(KC_1), SHIFT(KC_2), KC_UP, KC_HOME, KC_END, \
                                  KC_PGUP, KC_7, KC_8, KC_9, SHIFT(KC_8), \
 ...
 *       voldn  alt shift bksp ctrl || super space   L0  prtsc scroll pause
 */
